<?php
	...
	function add_mess($post,$user_id) {
		...
		if(!empty($_FILES['img']['tmp_name'])) {
			...
			$sql = "INSERT INTO ".PREF."post(
											title,text,img,date,id_user,id_categories,id_razd,town,phone,time_over,price
											)
			VALUES (
	...
	function get_e_mess($id_mess) {
		$sql = "SELECT id,title,text,date,id_user,id_categories,id_razd,town,phone,img,time_over,is_actual,price,img_s FROM ".PREF."post WHERE id='$id_mess'";
